...
public class Printest {
    ...
    /*
       public static void main(String[] args) throws IOException, PrinterException {
               ...
               String fileName = "C:/TicketOpenShop/aaaa-Ticket-V01.pdf";
  ...
  */
  ...
  public  void COM(String fileName) {
      ...
      // pour chaque pari il faut ajourter 25 de hauteur, il faut trouver un moyen d'estimer les info du bas.
        ...
        Document document = new Document(new Rectangle(300, 775)); 
     ...
     //   tic.setFichierTicket("C:/logoTicket/AATicket-Caisse--A7-font10--version-222-450b.pdf");
       ...
       document.addTitle("eShop Facture");
  ...
  try {
            ...
            Image image1 = Image.getInstance("/resources/Ticket_de_caisse/logo_ballon_couronne.png");
       // image1.setAlignment(Image.MIDDLE);
            image1.scalePercent(75, 75);
            image1.setAlignment(Image.ALIGN_CENTER);
         //document.isInline();
         
           document.add(image1);
           Font FontTitre = new Font(Font.FontFamily.TIMES_ROMAN, 11,Font.BOLD);
            Paragraph preface = new Paragraph("eShop", FontTitre);
   ...
   // addEmptyLine(preface, 1);
    // Lets write a big header
       ...
       //   document.add(new Paragraph(" Caisse Nr. 25803  Pari. 478-523-690 ", fontTicket));
          ...
          phrase.add("Paris Multi 7 validés - Partenaire Nro. 24563");
       //   document.add(new Phrase(" "));
          document.add(phrase);
      ...
      /***1  Image image2 = Image.getInstance("QR_Code75.PNG");
